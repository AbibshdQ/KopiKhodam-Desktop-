...
//        this.setExtendedState(JFrame.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("D:\\Kuliah\\veron\\POLITEKNIK\\Semester 4\\Project Desktop\\Icon\\Riwayat.png")); // NOI18N
        ...
        TRiwayat.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Tanggal Pemesanan", "Total Pemesanan"
            }
        ));
        TRiwayat.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(TRiwayat);
        if (TRiwayat.getColumnModel().getColumnCount() > 0) {
            TRiwayat.getColumnModel().getColumn(0).setMaxWidth(100);
        }
